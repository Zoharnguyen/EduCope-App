...
import 'manage-adjust-mem-in-class-T-and-P.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ManageDetailEndClassTandPPage(
          '', checkCourseBelongUserGlobal, previousScreenGlobal),
    );
  }
}

class ManageDetailEndClassTandPPage extends StatefulWidget {
  ...
  @override
  _ManageDetailEndClassTandPPagePageState createState() =>
      _ManageDetailEndClassTandPPagePageState();
}

class _ManageDetailEndClassTandPPagePageState
    extends State<ManageDetailEndClassTandPPage> {
  Offer _offer =
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          DetailInformationOpeningAndNotOfferClassTandPPage(
                                              ...
                                              FromScreen.fromScreenManageEndClass,
                                              courseIdGlobal)));
                            },
                            child: Text(
                              'Thông tin lớp học',
